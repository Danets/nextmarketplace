...
export const Navbar = ({ stores }: NavbarProps) => {
    ...
    const links = [
        ...
        },
        {
            ...
            label: "Sizes",
            active: path === `/${storeId}/sizes` ? "default" : "ghost"
        },
        {
            href: storeId ? `/${storeId}/colors` : "/",
            label: "Colors",
            active: path === `/${storeId}/colors` ? "default" : "ghost"
        },
        {
            href: storeId ? `/${storeId}/products` : "/",
            label: "Products",
            active: path === `/${storeId}/products` ? "default" : "ghost"
        },
        {
            href: storeId ? `/${storeId}/orders` : "/",
            label: "Orders",
            active: path === `/${storeId}/orders` ? "default" : "ghost"
        },
        {
            href: "/settings",
            label: "User Settings",
